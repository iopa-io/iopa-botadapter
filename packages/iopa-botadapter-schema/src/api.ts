...
export enum ActionTypes {
    OpenUrl = <any>'openUrl',
    ImBack = <any>'imBack',
    PostBack = <any>'postBack',
    PlayAudio = <any>'playAudio',
    PlayVideo = <any>'playVideo',
    ShowImage = <any>'showImage',
    DownloadFile = <any>'downloadFile',
    Signin = <any>'signin',
    Call = <any>'call',
    Payment = <any>'payment',
    MessageBack = <any>'messageBack',
}
...
export enum ActivityTypes {
    Message = <any>'message',
    ContactRelationUpdate = <any>'contactRelationUpdate',
    ConversationUpdate = <any>'conversationUpdate',
    Typing = <any>'typing',
    EndOfConversation = <any>'endOfConversation',
    Event = <any>'event',
    Invoke = <any>'invoke',
    DeleteUserData = <any>'deleteUserData',
    MessageUpdate = <any>'messageUpdate',
    MessageDelete = <any>'messageDelete',
    InstallationUpdate = <any>'installationUpdate',
    MessageReaction = <any>'messageReaction',
...
export enum EndOfConversationCodes {
    Unknown = <any>'unknown',
    CompletedSuccessfully = <any>'completedSuccessfully',
    UserCancelled = <any>'userCancelled',
    BotTimedOut = <any>'botTimedOut',
    BotIssuedInvalidMessage = <any>'botIssuedInvalidMessage',
    ChannelFailed = <any>'channelFailed',
}
...
export enum InputHints {
    AcceptingInput = <any>'acceptingInput',
    IgnoringInput = <any>'ignoringInput',
    ExpectingInput = <any>'expectingInput',
}
 ...
 * @enum {string}
 */
export enum SemanticActionStates {
    Start = <any>'start',
 ...
 * @export
 */
export const AttachmentsApiFetchParamCreator = function(
    configuration?: Configuration
) {
    return {
        /**
...
export const AttachmentsApiFp = function(configuration?: Configuration) {
    return {
        ...
        attachmentsGetAttachment(
            ...
            const localVarFetchArgs = AttachmentsApiFetchParamCreator(
                configuration
...
export const AttachmentsApiFactory = function(
    ...
    return {
        ...
        attachmentsGetAttachment(
            ...
            return AttachmentsApiFp(configuration).attachmentsGetAttachment(
                attachmentId,
                viewId,
                options
            )(fetch, basePath)
         ...
         * @throws {RequiredError}
         */
        attachmentsGetAttachmentInfo(attachmentId: string, options?: any) {
            return AttachmentsApiFp(configuration).attachmentsGetAttachmentInfo(
                attachmentId,
                options
            )(fetch, basePath)
        },
...
export class AttachmentsApi extends BaseAPI implements AttachmentsApiInterface {
     ...
     */
    public attachmentsGetAttachment(
        attachmentId: string,
        viewId: string,
        options?: any
    ) {
        return AttachmentsApiFp(this.configuration).attachmentsGetAttachment(
            attachmentId,
            viewId,
            options
     ...
     * @memberof AttachmentsApi
     */
    public attachmentsGetAttachmentInfo(attachmentId: string, options?: any) {
 ...
 * @export
 */
export const ConversationsApiFetchParamCreator = function(
    configuration?: Configuration
) {
    return {
        /**
        ...
        conversationsCreateConversation(
            ...
            const needsSerialization =
                <any>'ConversationParameters' !== 'string' ||
...
export const ConversationsApiFp = function(configuration?: Configuration) {
    return {
        ...
        conversationsCreateConversation(
            ...
            const localVarFetchArgs = ConversationsApiFetchParamCreator(
                configuration
...
export class ConversationsApi extends BaseAPI
     ...
     */
    public conversationsCreateConversation(
        parameters: ConversationParameters,
        options?: any
    ) {
        return ConversationsApiFp(
     ...
     * @memberof ConversationsApi
     */
    public conversationsDeleteActivity(
        conversationId: string,
        activityId: string,
        options?: any
    ) {
     ...
     * @memberof ConversationsApi
     */
    public conversationsDeleteConversationMember(
        conversationId: string,
        memberId: string,
        options?: any
    ) {
     ...
     * @memberof ConversationsApi
     */
    public conversationsGetActivityMembers(
        conversationId: string,
        activityId: string,
        options?: any
    ) {
     ...
     * @memberof ConversationsApi
     */
    public conversationsGetConversationMembers(
        conversationId: string,
        options?: any
    ) {
        return ConversationsApiFp(
     ...
     * @memberof ConversationsApi
     */
    public conversationsGetConversationPagedMembers(
        conversationId: string,
        pageSize?: number,
        continuationToken?: string,
        options?: any
     ...
     * @memberof ConversationsApi
     */
    public conversationsGetConversations(
        continuationToken?: string,
        options?: any
    ) {
        return ConversationsApiFp(
     ...
     * @memberof ConversationsApi
     */
    public conversationsReplyToActivity(
        conversationId: string,
        activityId: string,
        activity: Activity,
        options?: any
     ...
     * @memberof ConversationsApi
     */
    public conversationsSendConversationHistory(
        conversationId: string,
        history: Transcript,
        options?: any
    ) {
     ...
     * @memberof ConversationsApi
     */
    public conversationsSendToConversation(
        conversationId: string,
        activity: Activity,
        options?: any
    ) {
     ...
     * @memberof ConversationsApi
     */
    public conversationsUpdateActivity(
        conversationId: string,
        activityId: string,
        activity: Activity,
        options?: any
     ...
     * @memberof ConversationsApi
     */
    public conversationsUploadAttachment(
        conversationId: string,
        attachmentUpload: AttachmentData,
        options?: any
    ) {
